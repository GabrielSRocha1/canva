...
export namespace Prisma {
  ...
  */
  ...
  export type EntryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"key" | "value" | "updatedAt", ExtArgs["result"]["entry"]>
  ...
  export interface EntryDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `key`
     * const entryWithKeyOnly = await prisma.entry.findMany({ select: { key: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Entries and only return the `key`
     * const entryWithKeyOnly = await prisma.entry.createManyAndReturn({
     *   select: { key: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Entries and only return the `key`
     * const entryWithKeyOnly = await prisma.entry.updateManyAndReturn({
     *   select: { key: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface EntryFieldRefs {
    readonly key: FieldRef<"Entry", 'String'>
    readonly value: FieldRef<"Entry", 'String'>
  ...
  export type EntryWhereInput = {
    ...
    key?: StringFilter<"Entry"> | string
    value?: StringFilter<"Entry"> | string
  ...
  export type EntryScalarWhereWithAggregatesInput = {
    ...
    key?: StringWithAggregatesFilter<"Entry"> | string
    value?: StringWithAggregatesFilter<"Entry"> | string
